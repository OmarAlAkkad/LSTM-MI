# -*- coding: utf-8 -*-
"""
Created on Wed Jan 25 14:08:39 2023
...
def build_model(train, num_classes):
    ...
    model = keras.Model(inputs=inputs, outputs=outputs, name="shadow_mnist")
...
if __name__ == "__main__":
    ...
    locals()['shadow_model_dataframe_mnist'] = pd.DataFrame(data=d)

    pickle.dump(locals()['shadow_model_dataframe_mnist'], open('shadow_renet_dataframe_mnist.p', 'wb'))
