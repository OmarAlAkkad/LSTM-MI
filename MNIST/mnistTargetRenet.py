# -*- coding: utf-8 -*-
"""
Created on Mon Feb  6 17:34:09 2023
...
if __name__ == '__main__':
    ...
    locals()['target_renet_dataframe_mnist'] = pd.DataFrame(data=d)

    pickle.dump(locals()['target_renet_dataframe_mnist'], open('target_renet_dataframe_mnist.p', 'wb'))
    ...
    d.to_csv(f'target_renet_mnist.csv')
