# -*- coding: utf-8 -*-
"""
Created on Tue Jan 24 13:54:33 2023
...
def load_data():
    data_file = open(f'target_renet_dataframe_insect.p', 'rb')
    target = pickle.load(data_file)
    data_file.close()

    data_file = open(f'shadow_renet_dataframe_insect.p', 'rb')
...
if __name__ == "__main__":
    ...
    d.to_csv(f'renet_attack_models.csv')
