# -*- coding: utf-8 -*-
"""
Created on Mon Oct 17 16:15:00 2022
...
def load_data():
    data_file = open(f'target_model_dataframe_CBF.p', 'rb')
    actual = pickle.load(data_file)
    data_file.close()

    data_file = open(f'shadow_model_dataframe_CBF.p', 'rb')
...
if __name__ == "__main__":
    ...
    history = model.fit(x_train, y_train, epochs = 1000, validation_data = (x_test, y_test), verbose =1,batch_size= 200)
