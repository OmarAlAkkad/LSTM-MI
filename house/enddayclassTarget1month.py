...
if __name__ == "__main__":
    ...
    for month in test_months:
        ...
        locals()[f'{month}_target_model_dataframe_enddays'] = pd.DataFrame(data=d)

        pickle.dump(locals()[f'{month}_target_model_dataframe_enddays'], open(f'{month}_target_model_dataframe_enddays.p', 'wb'))
        ...
        d.to_csv(f'{month}_target_enddays_class.csv')
        ...
        # plt.figure()
        # plt.title(f'{month} Target Model Training set success rate')
        # plt.bar(number_of_months,train_months_percentage)
        # plt.figure()
        # plt.title(f'{month} Target Model Testing set success rate')
        # plt.bar(number_of_months,test_months_percentage)
        # plt.figure()
        # plt.title(f'{month} Target Model Number of each month in training set')
        # plt.bar(number_of_months,count_train_months)
        # plt.figure()
        # plt.title(f'{month} Target Model Number of each month in testing set')
