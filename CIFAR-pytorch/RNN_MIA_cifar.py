...
if __name__ == "__main__":
    ...
    for data,method_name,save_model_folder,name in models:
        target_trainloader, target_testloader, shadow_trainloader, shadow_testloader = create_cifar_dataset_torch(data, load_data = False, batch_size=64, target_train_size = 17500, target_test_size= 17500, shadow_train_size = 17500, shadow_test_size= 17500)
