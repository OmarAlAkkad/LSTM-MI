...
def load_data():
    data_file = open('actual_model_data.p', 'rb')
    data = pickle.load(data_file)
    data_file.close()

    data_file = open('actual_model_labels.p', 'rb')
...
if __name__ == "__main__":
    ...
    df.to_csv('Target Model Train and Test RMSE enddays.csv')
